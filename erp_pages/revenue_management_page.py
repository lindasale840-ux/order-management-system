...
def show_revenue_management_page():
    ...
    # =========================
    # Other Revenue Management TABLE
    # =========================
    st.divider()
    ...
    if advertisers_exist := other_revenue_df.empty:
        st.info(
            "No other revenue found"
        )
    else:
        # SỬA LỖI: Thêm key="other_revenue_management_grid"
        render_aggrid(
            other_revenue_df,
            height=300,
            page_size=10,
            key="other_revenue_management_grid"
        )
    ...
    # =========================
    # TOTAL REVENUE DISPLAY DATA FRAME TABLE
    # =========================
    display_df = df[
        [
            "customer_name",
    ...
    # SỬA LỖI: Thêm key="total_revenue_display_grid"
    render_aggrid(
        display_df,
        height=500,
        page_size=10,
        key="total_revenue_display_grid"
    )
